...
void OLED_Init(void)
{
	...
	write_cmd(0xA1); //���ض�������,bit0:0,0->0;1,0->127;
	write_cmd(0xC0); //����COMɨ�跽��;bit3:0,��ͨģʽ;1,�ض���ģʽ COM[N-1]->COM0;N:��·��
	write_cmd(0xDA); //����COMӲ���������
	write_cmd(0x12); //[5:4]����

	write_cmd(0x81); //�Աȶ�����
	write_cmd(0xEF); //1~255;Ĭ��0X7F (��������,Խ��Խ��)
	write_cmd(0xD9); //����Ԥ�������
	...
	write_cmd(0xA6); //������ʾ��ʽ;bit0:1,������ʾ;0,����ʾ
	write_cmd(0xAF); //������ʾ
	OLED_Clear();
}
// end of files
